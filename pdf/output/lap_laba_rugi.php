...
$html = '<p style="text-align: center;"><strong>LAPORAN LABA RUGI</strong></p>
...
// SELECT jual_detail.*,produk.id_produk_kategori,jual.tanggal_transaksi FROM jual_detail,produk,jual WHERE jual_detail.id_produk=produk.id_produk AND jual.id_jual=jual_detail.id_jual
$html .= '
<table>
    <tr>
...
$total_pemasukan = 0;
$sql_pendapatan = "SELECT akun,sum(kredit-debet) as total_pendapatan from akun_mutasi,akun_jurnal,akun where akun_mutasi.id_akun_jurnal=akun_jurnal.id_akun_jurnal and akun_mutasi.id_akun=akun.id_akun and akun.tipe='pendapatan' AND akun_jurnal.tanggal_transaksi BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY akun_mutasi.id_akun";
...
$html .= '  
    <tr>
        <td></td>
        <td style="border-top: 1px solid #000;">Total Pendapatan</td>
...
$total_biaya = 0;
$sql_biaya = "SELECT akun,sum(debet-kredit) as total_biaya from akun_mutasi,akun_jurnal,akun where akun_mutasi.id_akun_jurnal=akun_jurnal.id_akun_jurnal and akun_mutasi.id_akun=akun.id_akun and akun.tipe='biaya' AND akun_jurnal.tanggal_transaksi BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY akun_mutasi.id_akun";
...
$html .= '
    <tr>
    <td></td>
    <td style="border-top: 1px solid #000;">Total Biaya</td>
