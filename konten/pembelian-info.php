        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3>Informasi Transaksi Pembelian</h3>
            </div> 
            <div class="card-body">              
                <?php
                $sql1="select beli.*,pemasok.nama as nama_pemasok from beli,pemasok where beli.id_pemasok=pemasok.id_pemasok and md5(id_beli)='$id_beli'";
...
<?php
                  ...
                  $sql2="select beli_detail.*,produk.nama from beli_detail,produk where beli_detail.id_produk=produk.id_produk and md5(id_beli)='$id_beli'";
